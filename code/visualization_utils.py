      ...
      if scores is None:
        ...
        if not skip_scores:
          if not display_str:
            ...
            print("\n> we find ",display_str," at [ %d %d %d %d ]" %(box[0]*720, box[1]*1280, box[2]*720, box[3]*1280))
            loc.append([box[0]*720, box[1]*1280, box[2]*720, box[3]*1280])
            return_name.append(display_str)
